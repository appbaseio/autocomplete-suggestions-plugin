...
},{"@algolia/autocomplete-js":"3Dm7o","@algolia/autocomplete-theme-classic":"4ZOnh","@appbaseio/autocomplete-suggestions-plugin":"3uHrG","preact":"4L2dE","./utils":"2SL7q","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"3Dm7o":[function(require,module,exports) {
var define;
    ...
    getSources: function (u) {
      ...
      return [{
        ...
        onSelect(p) {
          ...
          (console.log(f), d(f._category ? f.label : f.value), g());
        },
        templates: {
          header(p) {
...
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
_parcelHelpers.export(exports, "getIcon", function () {
  return getIcon;
});
_parcelHelpers.export(exports, "processSuggestions", function () {
  return processSuggestions;
});
_parcelHelpers.export(exports, "processResults", function () {
  return processResults;
});
const RecentSearchIcon = () => /*#__PURE__*/React.createElement("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  alt: "Recent Search",
  height: "20",
  width: "20",
...
const PopularSeachIcon = () => /*#__PURE__*/React.createElement("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  alt: "Popular Search",
  height: "20",
  width: "20",
...
const PromotedIcon = () => /*#__PURE__*/React.createElement("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  width: "20",
  height: "20",
  viewBox: "0 0 24 24",
...
const processSuggestions = results => {
  return results.map(({label = "---", url = "---", value = "---", _suggestion_type = "index", _source}) => ({
    value,
    url: url,
...
},{"@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}]},["63iPG","4ThtM"], "4ThtM", "parcelRequire4e8e")
